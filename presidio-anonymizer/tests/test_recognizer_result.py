...
def test_logger(mock_logger):
    ...
    mock_logger = create_recognizer_result("Entity", 6.9, 1, 4)

    
    mock_logger.logger.info.assert_called_with("created analyzer result: entity_type='Entity', start=1, end=4, score=6.90")
